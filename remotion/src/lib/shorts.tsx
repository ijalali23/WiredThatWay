...
// bottom ~500 / top ~150-180 / right ~160-170 matches the single-line username+caption+music
// row and the like/comment/share/save column on all three platforms in normal (non-ad) view;
// verified by actually rendering a caption at a much larger bottom margin (620) and finding it
// collided with this kit's OWN hero content instead — real composition space is the binding
// constraint here, not a worst-case platform figure that only applies under an ad overlay.
// (The vox-2 bug this was chasing wasn't the kit's numbers: it was one shot overriding
// Captions' y to 1620, ignoring this already-adequate default — see that shot's script.md.)
export const SAFE = { top: 180, bottom: 500, right: 170, left: 60 } as const;
